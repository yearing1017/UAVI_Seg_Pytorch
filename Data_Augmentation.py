...
class DataAugmentation:
    ...
    def randomCrop(image, label):
        ...
        crop_win_size = np.random.randint(280, 300)
        random_region = (
...
if __name__ == '__main__':
    threadOPS("data/dataset1/train_images_noaug/",
              "data/dataset1/images_prepped_train/",
              "data/dataset1/train_anno_noaug/",
              "data/dataset1/anno_prepped_train/")
