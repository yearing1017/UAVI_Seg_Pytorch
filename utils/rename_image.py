...
def imageSegmentationGenerator(segs_path):
    ...
    #for index, im_fn in enumerate(images):
        ...
        cv2.imwrite("data/dataset2/augmentor/label_rename/"+"aug_"+str(index)+".png", seg)
        print(index,"：保存成功！")
        '''
        cv2.imshow(
            "equalize_hist_img",
...
segmentations = "data/dataset2/augmentor/out_label/"
#annotations = "data/dataset2/i_crop/out_image/"
#n_classes = 4

imageSegmentationGenerator(segmentations)
