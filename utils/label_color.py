...
def imageSegmentationGenerator(segs_path, n_classes):
    ...
    colors = [(0,0,255),(255,0,0),(255,255,0),(0,255,255),(0,255,0),(255,255,255)]
    ...
    for anno_name in anno:
        ...
        cv2.imwrite("/Users/yearing1017/矿区地物提取/deeplabv3/test_data/file_color_true/" + anno_name, seg_img)
        #cv2.imwrite("/Users/yearing1017/矿区地物提取/202010_new/fushi-res/" + anno_name, seg_img)
        print(anno_name+"：保存成功！")


#images = "data/dataset1/image_vis/"
annotations = "/Users/yearing1017/矿区地物提取/deeplabv3/test_data/file_color/"
#annotations = "/Users/yearing1017/矿区地物提取/202010_new/fushi-wait/"
n_classes = 6
