...
### 4. [ACNet_v1002版本](https://github.com/yearing1017/Deeplabv3_Pytorch/tree/master/RGBD%E8%AF%AD%E4%B9%89%E5%88%86%E5%89%B2/ACNet_v1002)

#### 3.1 实验简介
- 网络：ACNet原始网络；
- v0923的对照实验；Focal_loss替换CrossEntropyLoss
- baseline：resnet50的layer1-4；
- 训练与验证：5折交叉验证；
- 训练轮次数：epoch = 45；
- 模型的评价标准：MIoU；
